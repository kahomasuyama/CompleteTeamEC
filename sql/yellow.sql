...
( 4, 4,"FACE YOURSELF","ふぇいすゆあーせるふ","洋楽４の商品詳細",2,100,"./images","洋楽4.jpg",now(),"発売会社",0,now(),now()),
( 5, 5,"CALL ME MAYBE","こーるみーめいびー","洋楽５の商品詳細",2,100,"./images","洋楽5.jpg",now(),"発売会社",0,now(),now()),
