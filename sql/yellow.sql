...
( 5, 5,"洋楽５","ようがく５","洋楽５の商品詳細",2,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
( 6, 6, "邦楽１","ほうがく１","邦楽１の商品詳細",3,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
( 7, 7, "邦楽２","ほうがく２","邦楽２の商品詳細",3,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
( 8, 8, "邦楽３","ほうがく３","邦楽３の商品詳細",3,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
( 9, 9, "邦楽４","ほうがく４","邦楽４の商品詳細",3,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
( 10, 10, "邦楽５","ほうがく５","邦楽５の商品詳細",3,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
( 11, 11, "サウンドトラック１","さうんどとらっく１","サウンドトラック１の商品詳細",4,100,"./images","soundtrack1.jpg",now(),"発売会社",0,now(),now()),
( 12, 12, "サウンドトラック２","さうんどとらっく２","サウンドトラック２の商品詳細",4,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
( 13, 13, "サウンドトラック３","さうんどとらっく３","サウンドトラック３の商品詳細",4,100,"./images","sample.jpg",now(),"発売会社",0,now(),now()),
